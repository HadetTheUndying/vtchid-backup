 ...
 *
 * $Id: setting.c,v 1.5 2004/06/14 13:00:11 hos Exp $
 *
 */
...
static int apply_device_setting(controller_setting_t *conf, int load_flag)
{
    ...
    struct {
        ...
        {L"auto light", &conf->auto_light, 1},
        {L"light slowly off speed", &conf->light_slowly_off_speed, 20},
...
int verify_device_setting(controller_setting_t *conf)
{
    ...
    /* range of DWORD values */
    {
        struct {
            ...
            {&conf->auto_light, 0, 1},
            {&conf->light_slowly_off_speed, 0, 250},
